...
export function ActivityCardWrapper({data, user, activities, voice, stream}) {
    ...
    return (
        <div className="activityProfileContainer activityProfileContainerNormal">
            { !stream ? <VoiceCard data={data} voice={voice} stream={stream} /> : <StreamCard user={user} voice={voice} /> }
