...
const [
	...
	{ filter: betterdiscord.Webpack.Filters.byStrings("ERROR", "tooltipNote"), searchExports: true }
);
...
function AboutTab({ data, user, displayProfile }) {
	...
	return BdApi.React.createElement("div", { className: "infoScroller scrollerBase", style: { overflow: "hidden scroll", paddingRight: "12px" } }, displayProfile?.pronouns && BdApi.React.createElement("div", { className: "userInfoSection" }, BdApi.React.createElement("div", { className: "userInfoSectionHeader" }, intl.intl.formatToPlainString(intl.t["+T3RIy"])), BdApi.React.createElement("div", { className: "userPronouns", style: { color: "var(--text-default)", fontSize: "14px" } }, displayProfile.pronouns)), BdApi.React.createElement("div", { className: "userInfoSection" }, BdApi.React.createElement(BioBuilder, { displayProfile })), BdApi.React.createElement("div", { className: "userInfoSection" }, BdApi.React.createElement(RoleBuilder, { user, data, displayProfile })), BdApi.React.createElement("div", { className: "userInfoSection" }, BdApi.React.createElement("div", { className: "userInfoSectionHeader" }, intl.intl.formatToPlainString(intl.t["a6XYDw"])), BdApi.React.createElement("div", { className: "memberSinceWrapper", style: { display: "flex", gap: "8px", alignItems: "center" } }, MemberDateBuilder({ data, user }))), BdApi.React.createElement("div", { className: "userInfoSection" }, BdApi.React.createElement("div", { className: "userInfoSectionHeader" }, intl.intl.formatToPlainString(intl.t["PbMNh4"])), BdApi.React.createElement(NoteComponent, { userId: user.id })), BdApi.React.createElement("div", { className: "userInfoSection", style: { borderTop: "1px solid var(--background-modifier-accent, var(--background-modifider-active))" } }, BdApi.React.createElement(ConnectionCards, { user, connections })), BdApi.React.createElement("div", { "aria-hidden": true, style: { pointerEvents: "none", minHeight: "0px", minWidth: "1px", flex: "0 0 auto", height: "8px" } }));
}
...
const styles = Object.assign(
	{
		...
		hasText: betterdiscord.Webpack.getByKeys("primary", "hasText").hasText,
	...
	betterdiscord.Webpack.getByKeys("background", "content", "safetyTable"),
...
class NewOldProfiles {
	...
	start() {
		betterdiscord.Utils.forceLoad(betterdiscord.Webpack.getBySource(`"USER_PROFILE_MODAL_KEY:".concat`, { raw: true }).id).then(
