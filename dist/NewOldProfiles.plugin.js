...
function ActivityCard({ user, activity, check }) {
	...
	), BdApi.React.createElement(FlexInfo, { className: "contentImagesProfile content", style: { display: "grid", flex: "1", marginBottom: "3px" }, activity, inventoryEntry, check, type: "PLAYING" }), BdApi.React.createElement("div", { className: "buttonsWrapper actionsProfile" }, BdApi.React.createElement(ActivityButtons, { user, activity }))));
}
